...
const UploadDropzone = () => {
	...
	const { startUpload } = useUploadThing('uploadPdf')
					...
					<div className='flex items-center justify-center h-full w-full'>
						...
						>
							...
							{acceptedFiles && acceptedFiles[0] ? (
								<div
									className='max-w-xs bg-white flex items-center rounded-md overflow-hidden
								 outline outline-[1px] outline-zinc-200 divide-x divide-zinc-200'
								>
...
export const UploadButton = () => {
	...
	const onOpen = useCallback((isValue: boolean) => {
		if (!isValue) setIsOpen(isValue)
	}, [])
	return (
